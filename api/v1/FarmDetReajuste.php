...
//Procedimiento para agregar
        try {
            ...
            $stmt->bindParam(4, $_REQUEST{'FarmStrCantUnid'});
            $stmt->bindParam(5, $_REQUEST{'FarmStrPresentacion'});
            $stmt->bindParam(6, $_REQUEST{'FarmNumCantSolicit'});
            $stmt->bindParam(7, $_REQUEST{'FarmNumCantEntregad'});
            $stmt->bindParam(8, $_REQUEST{'FarmNumPrecUni'});
            $stmt->bindParam(9, $_REQUEST{'FarmStrNoLote'});
            $stmt->bindParam(10, $_REQUEST{'FarmDatFechaVenc'});
            $stmt->bindParam(11, $_REQUEST{'FarmNumIdKardexFarm'});
